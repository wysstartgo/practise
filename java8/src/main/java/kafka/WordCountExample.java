...
public class WordCountExample {
    ...
    public static void main(String[] args) throws Exception{
        ...
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.1.41:9092");
        ...
        source.flatMapValues(value -> Arrays.asList(pattern.split(value.toLowerCase()))).map(((key, value) -> new KeyValue<Object, Object>(key, value)))
                .mapValues(value -> value.toString()).foreach((key, value) -> System.out.println("key:" + key + "   value:" + value));
